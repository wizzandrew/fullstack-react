...
class Contact extends Component {
    ...
    validate(fname, lname, tel, email) {
        const errors = {
            firstname: '',
            lastname: '',
            telnum: '',
        ...
        if (this.state.touched.firstname && fname.length < 3) {
            errors.firstname = 'first name should be >= 3 char';
        }
        else if (this.state.touched.firstname && fname.length > 10) {
            errors.firstname = 'first name should be <= 10 char';
        }

        //last name validation
        if (this.state.touched.lastname && lname.length < 3) {
            errors.lastname = 'last name should be >= 3 char';
        }
        else if (this.state.touched.lastname && lname.length > 10) {
                    ...
                    <div className="col-12 col-md-9">
                        <Form onSubmit={this.handleSubmit}>
                            ...
                            <FormGroup row className='mb-2'>
                                ...
                                <Col md={10}>
                                    <Input type="textarea" id="feedback" name="feedback" rows="12" value={this.state.message}
                                        onChange={this.handleInputChange}
                                    />
                                </Col>
                            </FormGroup>
